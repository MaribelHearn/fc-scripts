    ...
    commands: {
        ...
        **/
        ...
        commandlist: function (src, channel, command) {
            var usercommands = require("scripts/usercmds.js").commands;
            var modcommands = require("scripts/modcmds.js").commands;
            var admincommands = require("scripts/admincmds.js").commands;
            var ownercommands = require("scripts/ownercmds.js").commands;
            var cusercommands = require("scripts/cusercmds.js").commands;
            var cmodcommands = require("scripts/cmodcmds.js").commands;
            var cadmincommands = require("scripts/cadmincmds.js").commands;
            var cownercommands = require("scripts/cownercmds.js").commands;
            var scriptmessage = border + "<h2>List of Commands</h2><br>";
            ...
            scriptmessage += "<br><br><timestamp/><br>" + border2;
        ...
        **/
        bigtextsettings: function (src, channel, command) {
            ...
            var bigtexts = require("plugins/funcmds.js").getBigtexts();
        ...
        addcommand: function (src, channel, command) {
            ...
            if (funcommands.hasBigtext(lower)) {
                helpers.starfox(src, channel, command, bots.command, "Error 400, that title may not be the same as that of an existing command.");
                return;
            }
        ...
        removecommand: function (src, channel, command) {
            ...
            sys.sendHtmlAll(helpers.bot(bots.command) + name + " has removed the custom bigtext command '" + lower + "'!", channel);
